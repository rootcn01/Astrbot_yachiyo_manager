# Segment BD commentary track (BV1Jhe16EELF, 31min 3-person talk). Same core as p2_segment2.
import json
import sys
import wave
...
SRC = r"E:\DATA\ClaudeWorkspace\Yachiyo_Project\mimo_tts_voicecheck\_tmp\bili_dl\BV1Jhe16EELF_main.wav"
OUT = r"E:\DATA\ClaudeWorkspace\Yachiyo_Project\mimo_tts_voicecheck\_tmp\bili_dl\bd_segments.json"
SR = 16000
FRAME = int(0.030 * SR)
